...
public sealed class AgentValidationBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
    where TRequest : class
{
    private readonly IEnumerable<IValidator<TRequest>> _validators;
    public AgentValidationBehavior(IEnumerable<IValidator<TRequest>> validators) => _validators = validators;
